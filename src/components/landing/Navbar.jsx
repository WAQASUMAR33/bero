        ...
        <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? 'bg-white/90 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
            <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
                ...
                <div className="hidden md:flex items-center gap-4">
                    <Link href="/login-choice" className="text-[#224fa6] font-bold hover:bg-blue-50 px-5 py-2.5 rounded-xl transition-all">
                        Login
                    </Link>
                    <Link href="/login-choice" className="bg-[#224fa6] hover:bg-[#1e438f] text-white px-5 py-2.5 rounded-xl font-bold shadow-lg shadow-blue-900/20 hover:shadow-xl transition-all active:scale-95">
                        Get Started
                    </Link>
                </div>
                ...
                {isOpen && (
                    ...
                    >
                        <div className="px-6 py-4 flex flex-col gap-4">
                            ...
                            <hr />
                            <Link href="/login-choice" className="text-[#224fa6] font-bold">Login</Link>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
