...
export default function ObservationTaskView({ task }) {
  return (
    <div className="space-y-4">
      ...
      {/* Observation Notes - Full Width */}
      <div className="bg-gray-50 rounded-xl p-3">
        <p className="text-xs font-medium text-gray-500 uppercase mb-2">Observation Notes</p>
        <p className="text-sm text-gray-900 whitespace-pre-wrap">{task.notes || 'No notes provided'}</p>
      </div>
