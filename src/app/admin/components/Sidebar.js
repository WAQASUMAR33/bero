    ...
    },
    {
      ...
      subItems: [
        ...
        },
        {
          ...
          name: 'Live Pipeline',
          permission: 'investigations.view',
          path: '/admin/investigations?tab=LIVE',
        },
        {
          id: 'held-investigations',
          name: 'Held Cases',
          permission: 'investigations.view',
          path: '/admin/investigations?tab=HELD',
        },
        {
          id: 'closed-investigations',
          name: 'Closed & Admitted',
          permission: 'investigations.view',
          path: '/admin/investigations?tab=CLOSED',
        },
      ],
    },
    {
