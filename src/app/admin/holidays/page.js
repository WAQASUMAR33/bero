...
export default function HolidaysPage() {
  ...
  const handleApprove = async (holidayId) => {
    try {
      ...
      if (result.success) {
        setHolidays(prev => prev.map(h => h.id === holidayId ? result.data : h));
            ...
            <>
              ...
              <div className="mt-6 bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                <div className="p-6 border-b border-gray-200">
                  <h3 className="text-lg font-semibold text-gray-900">Holiday Requests</h3>
                </div>
                                ...
                                <div className="flex items-center justify-end space-x-2">
                                  ...
                                  <button
                                    onClick={() => {
                                      ...
                                      if (reason) handleReject(holiday.id, reason);
                                    }}
