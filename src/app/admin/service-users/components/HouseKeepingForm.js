              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                    ...
                    <th className="text-left py-4 px-5 text-sm font-semibold text-gray-700 border-b border-gray-200">Task</th>
                    <th className="text-left py-4 px-5 text-sm font-semibold text-gray-700 border-b border-gray-200">Temperature Check?</th>
                ...
                <tbody>
                  {displayRows.map((r, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-5 text-sm text-gray-900 font-medium">{r.task || '-'}</td>
                      <td className="py-4 px-5 text-sm text-gray-900">{r.temperatureCheck || '-'}</td>
