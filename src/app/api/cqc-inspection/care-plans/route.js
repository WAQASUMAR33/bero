...
// GET /api/cqc-inspection/care-plans
export async function GET(request) {
  try {
    ...
    // Get all person-centred tasks for the year
    ...
    console.error('GET /cqc-inspection/care-plans error:', error);
    return NextResponse.json({
      success: false,
      error: 'Failed to fetch care plans data',
