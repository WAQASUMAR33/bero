...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.muacTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      ...
      if (body.muacInCm !== undefined) updateData.muacInCm = parseFloat(body.muacInCm);
      ...
      updateData = {
        ...
        time: body.time,
        muacInCm: body.muacInCm ? parseFloat(body.muacInCm) : undefined,
