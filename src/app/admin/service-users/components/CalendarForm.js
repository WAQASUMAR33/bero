    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8 border-t-4 border-[#224fa6]">
      ...
      {loading ? (
        ...
        <div className="mt-6 flex items-center justify-between">
          ...
          <button type="button" onClick={()=>{ setModalType('FAMILY'); setShowModal(true); }} className="flex items-center space-x-2 px-4 py-2 bg-gradient-to-r from-[#224fa6] to-[#3270e9] text-white rounded-lg hover:from-[#1a3d85] hover:to-[#2859c7] transition-all shadow-md hover:shadow-lg font-medium">
            ...
            <div className="bg-gradient-to-r from-[#224fa6] to-[#3270e9] text-white px-6 py-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  <select value={modalType} onChange={e=>setModalType(e.target.value)} className="border rounded-lg px-3 py-2 text-gray-900 bg-white">
