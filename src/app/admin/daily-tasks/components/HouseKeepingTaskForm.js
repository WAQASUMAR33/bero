...
export default function HouseKeepingTaskForm({ 
  formData, 
  setFormData, 
  serviceUsers, 
  isSubmitting, 
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-6">
      ...
      {/* Task */}
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-2">House Keeping Task *</label>
        <input 
          type="text"
          required 
          value={formData.task} 
          onChange={(e)=>setFormData({...formData, task:e.target.value})}
          placeholder="e.g., Vacuum living room, Clean bathroom, Laundry..."
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-900 focus:ring-2 focus:ring-[#224fa6] focus:border-transparent"
        />
      </div>
      ...
      <div>
        ...
        <textarea 
          ...
          placeholder="Additional notes about the house keeping task..."
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-gray-900 focus:ring-2 focus:ring-[#224fa6] focus:border-transparent"
        />
      </div>
