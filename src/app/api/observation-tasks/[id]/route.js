...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.observationTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      // Care workers can only update: task data, notes, emotion (observation tasks don't have completed field)
