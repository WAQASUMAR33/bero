...
const TABS = [
  { id: 'ALL', label: 'All Investigations', icon: Layers, countKey: 'total' },
  { id: 'In Progress', label: 'In Progress', icon: Activity, countKey: 'inProgress' },
  { id: 'Not Started', label: 'Not Started', icon: Clock, countKey: 'notStarted' },
