    ...
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden mb-8 border-t-4 border-[#224fa6]">
      ...
      <div className="p-6">
        ...
        <div>
          ...
          <p className="text-xs text-gray-600 mt-1">On Bathing tasks you are able to log catheter details.</p>
        </div>
        <div className="md:col-span-2">
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
            ...
            <div className="bg-gradient-to-r from-[#224fa6] to-[#3270e9] text-white px-6 py-4">
              <div className="flex items-center justify-between">
                <h3 className="text-xl font-semibold">Manage Team Options</h3>
                <button
                  type="button"
                  onClick={() => {
              ...
              <div className="mb-6">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-[#224fa6] to-[#3270e9] text-white font-medium hover:from-[#1a3d85] hover:to-[#2859c7] disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-md hover:shadow-lg"
                  >
                    Add
                  </button>
                </div>
