  ...
  return (
    <div className="bg-white rounded-lg border border-gray-200 p-6 mb-6">
      ...
      <div className="mt-6 flex items-center justify-between">
        ...
        <button type="button" onClick={openAdd} className="flex items-center space-x-2 px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors">
        ...
        <div className="fixed inset-0 backdrop-blur-md bg-black/30 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
            ...
            <div className="p-6 border-t border-gray-200 flex justify-end space-x-3">
              ...
              <button type="button" onClick={saveRow} disabled={saving || !formData.fundingSourceId} className="px-6 py-2 border-2 border-dashed border-gray-300 rounded-lg text-gray-700 bg-gray-100 hover:bg-gray-200 disabled:opacity-70">{saving ? 'Saving...' : 'Save'}</button>
            </div>
          </div>
        </div>
      )}
      ...
      {showManageSources && (
        <div className="fixed inset-0 backdrop-blur-md bg-black/30 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-xl max-h-[90vh] overflow-hidden flex flex-col">
            <div className="p-6 border-b border-gray-200 flex items-center justify-between">
              <h3 className="text-xl font-semibold text-gray-900">Manage Funding Sources</h3>
              <button type="button" onClick={()=>setShowManageSources(false)} className="text-gray-500 hover:text-gray-700 text-2xl leading-none">×</button>
            </div>
            <div className="flex-1 overflow-y-auto p-6 space-y-4">
              ...
              <div className="border-t pt-4">
                ...
                <div className="mt-3 flex justify-end">
                  <button type="button" onClick={addSource} className="px-4 py-2 bg-[#224fa6] text-white rounded-lg">Add</button>
                </div>
              </div>
            </div>
          </div>
