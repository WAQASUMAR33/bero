...
const APP_PAGES = [
  ...
  { name: 'KPI & Monthly Evaluations', path: '/admin/kpi', description: 'Key performance indicators tracker, monthly evaluations, and governance action plan', keywords: ['kpi', 'key performance indicators', 'evaluation', 'monthly evaluation', 'tracker', 'action plan', 'occupancy', 'sickness', 'metrics'] },
