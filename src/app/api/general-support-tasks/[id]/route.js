...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.generalSupportTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      ...
      // Explicitly prevent updating serviceSeekerId, date, time, supportListId
    } else {
      ...
      updateData = {
        ...
        supportListId: body.supportListId ? parseInt(body.supportListId) : undefined,
