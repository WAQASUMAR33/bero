...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.personCentredTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      ...
      // Explicitly prevent updating serviceSeekerId, date, time, nameId
    } else {
      ...
      updateData = {
        ...
        time: body.time,
        nameId: body.nameId ? parseInt(body.nameId) : undefined,
