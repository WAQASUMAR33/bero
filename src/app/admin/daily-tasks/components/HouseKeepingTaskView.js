...
export default function HouseKeepingTaskView({ task, onClose }) {
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-3">
          ...
          <div className="bg-gray-50 rounded-xl p-3">
            <p className="text-xs font-medium text-gray-500 uppercase mb-1">House Keeping Task</p>
            <p className="text-base font-semibold text-gray-900">{task.task}</p>
          </div>
        ...
        <div className="space-y-3">
          {task.photoUrl && (
            <div className="bg-gray-50 rounded-xl p-3">
              ...
              <img src={task.photoUrl} alt="House keeping" className="w-full h-32 object-cover rounded-lg mt-2" />
            </div>
          )}
