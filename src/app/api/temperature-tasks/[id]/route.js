...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.temperatureTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      ...
      if (body.temperatureInC !== undefined) updateData.temperatureInC = parseFloat(body.temperatureInC);
      ...
      updateData = {
        ...
        time: body.time,
        temperatureInC: body.temperatureInC ? parseFloat(body.temperatureInC) : undefined,
