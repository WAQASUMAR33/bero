...
export const SUPPORT_PLAN_CATEGORIES = [
  ...
  { key: 'DECISION_MAKING', title: 'Decision making', icon: '⚖️', tag: 'Legal/Consent' },
  { key: 'EMOTIONAL_SUPPORT', title: 'Emotional Support', icon: '❤️', tag: 'Wellbeing' },
  ...
  { key: 'SLEEP', title: 'Sleep', icon: '🛏️', tag: 'Wellbeing' },
  ...
  { key: 'RELIGION_AND_CULTURE', title: 'Religion and Culture', icon: '🕊️', tag: 'Personal' },
  { key: 'SEXUALITY_AND_GENDER', title: 'Sexuality and Gender', icon: '⚧️', tag: 'Personal' },
  ...
  { key: 'SUBSTANCE_MISUSE', title: 'Substance Misuse', icon: '⚠️', tag: 'Lifestyle' },
