...
export async function PUT(request, { params }) {
  try {
    ...
    const existingTask = await prisma.bloodPressureTask.findUnique({
      where: { id: taskId },
      include: {
        serviceSeeker: true
      }
    ...
    if (isCareWorker) {
      ...
      if (body.systolicPressure !== undefined) {
        updateData.systolicPressure = parseInt(body.systolicPressure);
      }
      if (body.diastolicPressure !== undefined) {
        updateData.diastolicPressure = parseInt(body.diastolicPressure);
      }
      ...
      if (body.emotion !== undefined) {
        updateData.emotion = body.emotion;
      }
